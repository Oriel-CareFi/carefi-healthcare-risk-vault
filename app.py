...
CAREFI_LOGO_PATH = Path(__file__).parent / "assets" / "carefi_logo.jpg"
CAREFI_LOGO_DATA_URI = "data:image/jpeg;base64," + base64.b64encode(CAREFI_LOGO_PATH.read_bytes()).decode("ascii")
